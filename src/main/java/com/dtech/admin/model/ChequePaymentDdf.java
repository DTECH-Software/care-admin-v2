...
@Entity
@Table(name = "cheque_payment_ddf")
@Data
public class ChequePaymentDdf extends AdminAudit implements Serializable {
    ...
    @CollectionTable(name = "cheque_payment_ddf_month", joinColumns = @JoinColumn(name = "cheque_payment_id"))
    ...
    @JoinTable(
            name = "cheque_payment_ddf_document",
