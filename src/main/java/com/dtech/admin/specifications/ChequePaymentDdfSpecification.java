...
@Log4j2
public class ChequePaymentDdfSpecification {

    private ChequePaymentDdfSpecification() {
    }

    public static Specification<ChequePaymentDdf> getSpecification(ChequePaymentSearchDTO searchDTO) {
    ...
    public static Specification<ChequePaymentDdf> getSpecification() {
