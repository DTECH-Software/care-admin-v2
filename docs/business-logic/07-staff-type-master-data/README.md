# 07. Staff Type Master Data

Status: Current business baseline for BA / QA / client review

## Purpose
Explain the current business understanding of staff type master data so BA, QA, and client-side reviewers can validate the rule in the same language.

## Business Summary
Explains how staff type master data setup is maintained and reused across the system.
...
## Related Topics
- 06. Staff Category Master Data
- 08. Treatment Master Data
