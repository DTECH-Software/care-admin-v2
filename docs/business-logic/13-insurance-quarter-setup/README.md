...
## Purpose
Explain the current business understanding of insurance quarter setup so BA, QA, and client-side reviewers can validate the rule in the same language.

## Business Summary
Explains how insurance quarter setup setup is maintained and reused across the system.
