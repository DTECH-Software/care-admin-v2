...
## Purpose
Explain the current business understanding of medical claims report rules so BA, QA, and client-side reviewers can validate the rule in the same language.

## Business Summary
Explains how medical claims report rules rule affects payment and reporting outputs.
