...
## Purpose
Explain the current business understanding of common parameter driven rules so BA, QA, and client-side reviewers can validate the rule in the same language.

## Business Summary
Explains how common parameter driven rules supporting area enables the wider business process.
