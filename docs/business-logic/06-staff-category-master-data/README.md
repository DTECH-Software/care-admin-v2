...
## Purpose
Explain the current business understanding of staff category master data so BA, QA, and client-side reviewers can validate the rule in the same language.

## Business Summary
Explains how staff category master data setup is maintained and reused across the system.
