...
## Purpose
Explain the current business understanding of dashboard summary logic so BA, QA, and client-side reviewers can validate the rule in the same language.

## Business Summary
Explains how dashboard summary logic rule appears in approval, summary, or claim review flows.
