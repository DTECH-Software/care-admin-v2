...
## Purpose
Explain the current business understanding of password reset and otp so BA, QA, and client-side reviewers can validate the rule in the same language.

## Business Summary
Explains password reset and otp security and access rule in business terms.
