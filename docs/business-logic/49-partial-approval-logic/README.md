...
## Purpose
Explain the current business understanding of partial approval logic so BA, QA, and client-side reviewers can validate the rule in the same language.

## Business Summary
Explains how partial approval logic rule appears in approval, summary, or claim review flows.
