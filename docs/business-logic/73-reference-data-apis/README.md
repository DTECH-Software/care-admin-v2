...
## Purpose
Explain the current business understanding of reference data apis so BA, QA, and client-side reviewers can validate the rule in the same language.

## Business Summary
Explains how reference data apis supporting area enables the wider business process.
...
- 74. Common Parameter Driven Rules
