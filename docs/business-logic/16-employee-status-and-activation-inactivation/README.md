...
## Purpose
Explain the current business understanding of employee status and activation/inactivation so BA, QA, and client-side reviewers can validate the rule in the same language.

## Business Summary
Explains how employee status and activation/inactivation employee or dependent data affects claim behavior.
