...
## Purpose
Explain the current business understanding of company master data so BA, QA, and client-side reviewers can validate the rule in the same language.

## Business Summary
Explains how company master data setup is maintained and reused across the system.
