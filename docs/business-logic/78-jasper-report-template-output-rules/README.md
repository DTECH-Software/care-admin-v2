# 78. Jasper/Report Template Output Rules

Status: Current business baseline for BA / QA / client review

## Purpose
Explain the current business understanding of jasper/report template output rules so BA, QA, and client-side reviewers can validate the rule in the same language.

## Business Summary
Explains how jasper/report template output rules supporting area enables the wider business process.
