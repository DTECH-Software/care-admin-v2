...
## Purpose
Explain the current business understanding of policy period selection so BA, QA, and client-side reviewers can validate the rule in the same language.

## Business Summary
Explains how policy period selection rule is applied during claim request, balance, and claim processing.
