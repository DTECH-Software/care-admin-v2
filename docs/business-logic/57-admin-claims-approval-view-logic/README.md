...
## Purpose
Explain the current business understanding of admin claims approval view logic so BA, QA, and client-side reviewers can validate the rule in the same language.

## Business Summary
Explains how admin claims approval view logic rule appears in approval, summary, or claim review flows.
