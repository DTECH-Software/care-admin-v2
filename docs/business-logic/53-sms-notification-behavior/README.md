...
## Purpose
Explain the current business understanding of sms notification behavior so BA, QA, and client-side reviewers can validate the rule in the same language.

## Business Summary
Explains how sms notification behavior rule appears in approval, summary, or claim review flows.
