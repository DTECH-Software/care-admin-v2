# 27. Staff Category to Policy Mapping

Status: Current business baseline for BA / QA / client review

## Purpose
Explain the current business understanding of staff category to policy mapping so BA, QA, and client-side reviewers can validate the rule in the same language.

## Business Summary
Explains how staff category to policy mapping rule is applied during claim request, balance, and claim processing.
