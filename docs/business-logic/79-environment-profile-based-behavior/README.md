...
## Purpose
Explain the current business understanding of environment/profile based behavior so BA, QA, and client-side reviewers can validate the rule in the same language.

## Business Summary
Explains how environment/profile based behavior supporting area enables the wider business process.
