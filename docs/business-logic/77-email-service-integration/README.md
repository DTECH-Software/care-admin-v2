...
## Purpose
Explain the current business understanding of email service integration so BA, QA, and client-side reviewers can validate the rule in the same language.

## Business Summary
Explains how email service integration supporting area enables the wider business process.
