# 72. Duplicate Validation for OTP Related Identity Checks

Status: Current business baseline for BA / QA / client review

## Purpose
Explain the current business understanding of duplicate validation for otp related identity checks so BA, QA, and client-side reviewers can validate the rule in the same language.

## Business Summary
Explains how duplicate validation for otp related identity checks supporting area enables the wider business process.
