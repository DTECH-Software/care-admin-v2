...
## Purpose
Explain the current business understanding of rejection logic so BA, QA, and client-side reviewers can validate the rule in the same language.

## Business Summary
Explains how rejection logic rule appears in approval, summary, or claim review flows.
