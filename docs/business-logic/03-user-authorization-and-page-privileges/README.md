...
## Purpose
Explain the current business understanding of user authorization and page privileges so BA, QA, and client-side reviewers can validate the rule in the same language.

## Business Summary
Explains user authorization and page privileges security and access rule in business terms.
