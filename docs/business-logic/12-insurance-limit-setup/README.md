...
## Purpose
Explain the current business understanding of insurance limit setup so BA, QA, and client-side reviewers can validate the rule in the same language.

## Business Summary
Explains how insurance limit setup setup is maintained and reused across the system.
