...
## Purpose
Explain the current business understanding of ddf payment advice rules so BA, QA, and client-side reviewers can validate the rule in the same language.

## Business Summary
Explains how ddf payment advice rules rule affects payment and reporting outputs.
